...
Build the Analytics tab for completed futures Trades. Analytics should use date-range filtering by entry time and should not include planned, open, partial, or live-position concepts.
